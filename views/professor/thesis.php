...
?>
    ...
    <div class="row">
        <div class="col-sm-3 text-center">
            <a href= "<?= url::to('/thesis/thesis-create')?>" class="thumbnail">
        ...
        <div class="col-sm-3 text-center">
            <a href="<?= url::to('/thesis/thesis-active')?>" class="thumbnail">
        ...
        <div class="col-sm-3 text-center">
            <a href="<?= url::to('/thesis/thesis-committee')?>" class="thumbnail">
        ...
        <div class="col-sm-3 text-center">
            ...
            <a href="<?= url::to('/thesis/thesis-past')?>" class="thumbnail">
