...
use app\models\StudentReferencesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * StudentReferencesController implements the CRUD actions for References model.
 */
class StudentReferencesController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new StudentReferencesSearch();
